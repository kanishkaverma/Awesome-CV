...
\begin{cventries}
	...
	{May 2022 - September 2022} % Date(s)
	{
		\begin{cvitems} % Description(s) of tasks/resp
			...
			% \item {Improved the stability and performance of FortiOS, fixing bugs.}
			% \item {Improved the stability and performance of FortiOS, fixing over 30 bugs and increasing the speed of the web application.}
			...
			% \item {Acquired knowledge in networking, firewalls, and security, including TCP/IP, HTTP, encryption, and authentication.}
